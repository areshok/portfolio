...
class TestCaseCourier:
    ...
    @allure.title("""
    тест: проверка регистрации курьера, проверка успешного ответа
    ...
    с логином который уже есть в системе
    """)
    def test_cant_create_two_identical_couriers(self, database):
        ...
        print(f'class - {self.__class__.__name__} | method - {inspect.currentframe().f_code.co_name}')
